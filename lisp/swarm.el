...
(with-eval-after-load 'lsp-mode
  ...
  (lsp-register-client
   (make-lsp-client :new-connection (lsp-stdio-connection (list "/home/ollie/code/swarm/dist-newstyle/build/x86_64-linux/ghc-9.8.4/swarm-0.7.0.0/x/swarm/build/swarm/swarm" "lsp"))
